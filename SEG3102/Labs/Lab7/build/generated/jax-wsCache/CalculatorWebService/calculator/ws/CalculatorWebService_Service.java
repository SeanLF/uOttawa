 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://ws.calculator/", wsdlLocation = "http://localhost:8080/CalculatorWS/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://ws.calculator/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorWS/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://ws.calculator/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.calculator/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
