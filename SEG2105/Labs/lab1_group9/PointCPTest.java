...
public class PointCPTest {
	...
	public static void main(String[] args) {
		...
		// point for main method and for testing
		PointCP point;
		PointCP test;
		...
		// Create new PointCP with x,y -> [0,1] + manually change the coordinate type
		try {
			point = new PointCP("P".toUpperCase().charAt(0), Math.random(), Math.random());
		} catch (Exception e) {
		 ...
		 */ 
		test = new PointCP('P', Math.random(), Math.random());
	 ...
	 * @param point
	 */
	private static void testConstructor(PointCP point){
	 ...
	 * @param point
	 */
	private static void testGetterCartesian(PointCP point){
		// startTime for this method
	 ...
	 * @param point
	 */
	private static void testGetterPolar(PointCP point){
		// startTime for this method
		long startTimePolar;
		// j is used to keep track of the # of times we ran the constructor in 10s
		int k = 0;
