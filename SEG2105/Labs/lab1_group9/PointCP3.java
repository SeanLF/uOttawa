...
public class PointCP3 {
	...
	public PointCP3(char type, double x, double y) {
		...
		if(type=='C') {
			...
			this.x= (Math.cos(Math.toRadians(x)) * y);
	...
	public String convertStorageToPolar() {
			...
			// Return rho and theta in a string
			return ("Converted to Polar    ("+getRho() + ", " + getTheta() + ")" + "\n");
			
		
	}

	/**
	 * Method not necessary since only Cartesian coordinates are stored
	 * 
	...
	*/
	...
	public PointCP3 rotatePoint(double rotation) {
		...
		return new PointCP3('C', (Math.cos(radRotation) * X)
