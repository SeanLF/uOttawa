...
public class PointCPTest3 {
	...
	/**
	 * This method is responsible for the creation of the PointCP3 object. This
	...
	public static void main(String[] args) {		
			...
			System.out.println("Cartesian-Polar Coordinates Conversion Program 3");

			// Create new PointCP3 with x,y -> [0,1]
			try {
				point = new PointCP3("C".toUpperCase().charAt(0),Math.random(), Math.random());
			} catch (Exception e) {
			 ...
			 */ 
			test = new PointCP3('C', Math.random(), Math.random());
	 ...
	 * @param point
	 */
	private static void testConstructor(PointCP3 point){
	 ...
	 * @param point
	 */
	private static void testGetterCartesian(PointCP3 point){
		// startTime for this method
	 ...
	 * @param point
	 */
	private static void testGetterPolar(PointCP3 point){
		// startTime for this method
		long startTimePolar;
		// j is used to keep track of the # of times we ran the constructor in 10s
		int k = 0;
	 ...
	 * When the input is valid, it returns a PointCP3 object.
	 * 
	 * @return A PointCP3 constructed using information obtained from the user.
	 * @throws IOException
