...
/**
 * 
 * @author Hussein Al Osman (based on Jochen Lang implementation of SimpleGraph)
 *
 */
	...
	*/
	...
	protected void removeVertex( String vert){
		...
		if (v != null){
			...
			System.out.println(vert+" degree is "+graphTest.degree(v));
	...
	protected void insertEdge( String vert1, String vert2){
		...
		if (v1 != null && v2 !=null){
			// Vertex does exist, and therefore we can add it! 
			if(!graphTest.areAdjacent(v1, v2))
				graphTest.insertEdge(v1, v2, v1 + " to " + v2);
			else System.out.println("Can't add existing edge! "+v1+" to"+v2);
		}
	}
